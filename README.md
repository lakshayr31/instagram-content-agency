...
- `src/strategist/assess-content-item.ts`: audience-aware `important` / `watch` / `ignore` scoring.
- Linkup operator-initiated web research (server-side only; adapter to be added under `src/content-fetcher/`)
